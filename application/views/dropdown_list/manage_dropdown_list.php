				...
				<?php } ?>  
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong><?=$action?></strong> Drop Down </h3>
                                </div>
                                    ...
                                    <div class="row"><h5>Customer Information</h5>
                                     ...
                                     <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">    
                                                    <?php echo form_input('dropdown_value', set_value('dropdown_value',$result['dropdown_value'],false), 'id="dropdown_value" class="form-control" placeholder="Enter Dropdown Value"'.$dis.' '.$o_dis.' '); ?>
											...
											<div class="form-group col-md-6">
                                                    ...
                                                    <div class="col-md-9"> 
                                                       <div class="input-group"> 
                                                            <?php echo form_textarea(array('name'=>'dd_note','rows'=>'4','cols'=>'60','id'=>'dd_note', 'class'=>'form-control', 'placeholder'=>'Enter any Notes / Comments..' ),set_value('dd_note',$result['dd_note'],false),$dis.' '.$o_dis.' '); ?>
                                                       </div>  
                                                        <span class="help-block"><?php echo form_error('dd_note');?>&nbsp;</span>
                                                    </div>
                                            </div>
									</div>
                                      <div class="col-md-6"> 
