...
//            echo '<pre>';            print_r($report_data); die;
            ...
            $origin = '<table border="0">
                            ...
                            <tr>
                                <td height="30px" colspan="2" style="letter-spacing:3px;text-align:center;font-size:15px;"><b>'.strtoupper($report_data['variety_val']).'</b></td>
                            </tr>  
							<tr>
                                <td height="20px" colspan="2" style="letter-spacing:0.5px;line-height:0px;text-align:center;font-size:13px;">(Variety of '.$report_data['identification_val'].')</td>
                            </tr> 
                            <tr>
            ...
            $origin2 = '<table border="0">
							...
							<tr>
                                <td height="30px" colspan="2" style="letter-spacing:0.5px;line-height:0px;text-align:center;font-size:13px;">(Variety of '.$report_data['identification_val'].')</td>
                            </tr> 
                        </table>';
                        ...
                        <tr>
                            <td>
                                <table width="425px" border="0" id="report_content">
                                    ...
                                    <tr>
                                        <td width="26%" align="right"><b>Report No :</b></td>
                                        <td width="3%" align="center"></td>
                                    ...
                                    <tr>
                                        <td width="26%" align="right">Date :</td>
                                        <td width="3%" align="center"></td>
                                        <td width="78%">'.$report_data['report_date'].'</td>
                                    </tr>
                                    <tr>
                                        <td width="26%" align="right">Item :</td>
                                        <td width="3%" align="center"></td>
                                    ...
                                    <tr>
                                        <td width="26%" align="right">Weight :</td>
                                        <td width="3%" align="center"></td>
                                        <td width="78%">'.$report_data['weight'].' ct</td>
                                    </tr>
                                    <tr>
                                        <td width="26%" align="right">Measurements :</td>
                                        <td width="3%" align="center"></td>
                                    ...
                                    <tr>
                                        <td width="26%" align="right">Shape :</td>
                                        <td width="3%" align="center"></td>
                                        <td width="78%">'.$report_data['shape_val'].'</td>
                                    </tr>
                                    <tr>
                                        <td width="26%" align="right">Cut :</td>
                                        <td width="3%" align="center"></td>
                                    ...
                                    <tr>
                                        <td width="26%" align="right">Transperancy :</td>
                                        <td width="3%" align="center"></td>
                                        <td width="78%">'.$report_data['transparency'].'</td>
                                    </tr>
                                    <tr>
                                        <td width="26%" align="right">Colour :</td>
                                        <td width="3%" align="center"></td>
                                   ...
                                   '.$show_color_distribution.'
                                    ...
                                    <tr>
                                        <td width="26%" align="right"><b>Comments :</b></td>
                                        <td width="3%" align="center"></td>
...
$pdf->writeHTMLCell(140, 10, 10, 172, $html2);
$pdf->SetFontSize(10.5);
$pdf->writeHTMLCell(140, 10, 36,172, $html3); 
