                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                     <div class="col-md-6">
                                       ...
                                       <div class="form-group">
                                                    <label class="col-md-3 control-label">Phenomonon</label>
                                                    <div class="col-md-9">    
                                                       <div class="input-group"> 
                                                            <?php echo form_textarea(array('name'=>'phenomonon','rows'=>'4','cols'=>'60', 'class'=>'form-control', 'placeholder'=>'Enter any phenomonon' ),set_value('phenomonon',$result['phenomonon']),$dis.' '.$o_dis.' '); ?>
                                                       </div>  
